...
const Hero = () => {
  return (
    ...
    >
        <motion.div variants={fadeTop} {...motionStep}  className="flex flex-col md:flex-row items-center justify-between space-y-8 md:space-y-0 container mx-auto px-5 md:px-0">
